...
export function Button({
  ...
  const variantStyles = {
    primary: 'btn-primary text-white focus:ring-indigo-500',
    ...
    ghost: 'text-slate-600 dark:text-slate-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 focus:ring-indigo-500',
  };
