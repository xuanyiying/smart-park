...
func (_q *SessionQuery) QueryConnector() *ConnectorQuery {
...
func (_q *SessionQuery) WithConnector(opts ...func(*ConnectorQuery)) *SessionQuery {
	query := (&ConnectorClient{config: _q.config}).Query()
...
func (_q *SessionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Session, error) {
	...
	if query := _q.withConnector; query != nil {
		if err := _q.loadConnector(ctx, query, nodes, nil,
			func(n *Session, e *Connector) { n.Edges.Connector = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SessionQuery) loadConnector(ctx context.Context, query *ConnectorQuery, nodes []*Session, init func(*Session), assign func(*Session, *Connector)) error {
...
func (_q *SessionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withConnector != nil {
			_spec.Node.AddColumnOnce(session.FieldConnectorID)
		}
	}
