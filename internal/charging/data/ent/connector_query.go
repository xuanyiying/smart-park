...
func (_q *ConnectorQuery) QueryStation() *StationQuery {
...
func (_q *ConnectorQuery) QuerySessions() *SessionQuery {
...
func (_q *ConnectorQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ConnectorQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ConnectorQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ConnectorQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ConnectorQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ConnectorQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ConnectorQuery) WithStation(opts ...func(*StationQuery)) *ConnectorQuery {
	query := (&StationClient{config: _q.config}).Query()
...
func (_q *ConnectorQuery) WithSessions(opts ...func(*SessionQuery)) *ConnectorQuery {
	query := (&SessionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ConnectorQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Connector, error) {
	...
	if query := _q.withStation; query != nil {
		if err := _q.loadStation(ctx, query, nodes, nil,
			func(n *Connector, e *Station) { n.Edges.Station = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSessions; query != nil {
		if err := _q.loadSessions(ctx, query, nodes,
			func(n *Connector) { n.Edges.Sessions = []*Session{} },
			func(n *Connector, e *Session) { n.Edges.Sessions = append(n.Edges.Sessions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ConnectorQuery) loadStation(ctx context.Context, query *StationQuery, nodes []*Connector, init func(*Connector), assign func(*Connector, *Station)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Connector)
	for i := range nodes {
...
func (_q *ConnectorQuery) loadSessions(ctx context.Context, query *SessionQuery, nodes []*Connector, init func(*Connector), assign func(*Connector, *Session)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(session.FieldConnectorID)
	}
	query.Where(predicate.Session(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(connector.SessionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ConnectorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(connector.Table, connector.Columns, sqlgraph.NewFieldSpec(connector.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withStation != nil {
			_spec.Node.AddColumnOnce(connector.FieldStationID)
		}
	}
