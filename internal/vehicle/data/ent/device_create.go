...
func (_c *DeviceCreate) SetLotID(v uuid.UUID) *DeviceCreate {
	_c.mutation.SetLotID(v)
	return _c
}

// SetNillableLotID sets the "lot_id" field if the given value is not nil.
func (_c *DeviceCreate) SetNillableLotID(v *uuid.UUID) *DeviceCreate {
	if v != nil {
		_c.SetLotID(*v)
	}
	return _c
...
func (_c *DeviceCreate) SetLaneID(v uuid.UUID) *DeviceCreate {
	_c.mutation.SetLaneID(v)
	return _c
}

// SetNillableLaneID sets the "lane_id" field if the given value is not nil.
func (_c *DeviceCreate) SetNillableLaneID(v *uuid.UUID) *DeviceCreate {
	if v != nil {
		_c.SetLaneID(*v)
	}
	return _c
...
func (_c *DeviceCreate) SetDeviceSecret(v string) *DeviceCreate {
...
func (_c *DeviceCreate) SetGateID(v string) *DeviceCreate {
	_c.mutation.SetGateID(v)
	return _c
}

// SetNillableGateID sets the "gate_id" field if the given value is not nil.
func (_c *DeviceCreate) SetNillableGateID(v *string) *DeviceCreate {
	if v != nil {
		_c.SetGateID(*v)
	}
	return _c
...
func (_c *DeviceCreate) SetEnabled(v bool) *DeviceCreate {
	_c.mutation.SetEnabled(v)
	return _c
}

// SetNillableEnabled sets the "enabled" field if the given value is not nil.
func (_c *DeviceCreate) SetNillableEnabled(v *bool) *DeviceCreate {
	if v != nil {
		_c.SetEnabled(*v)
	}
	return _c
...
func (_c *DeviceCreate) check() error {
	...
	if _, ok := _c.mutation.DeviceSecret(); !ok {
		return &ValidationError{Name: "device_secret", err: errors.New(`ent: missing required field "Device.device_secret"`)}
	}
	if v, ok := _c.mutation.DeviceSecret(); ok {
